 ...
 * 支持上传文件和参数
 */
public class UploadExUtil {
	 private static final CommonLog log = LogFactory.createLog();
	 
	private static UploadExUtil uploadUtil;
	private static final String BOUNDARY =  UUID.randomUUID().toString(); // 边界标识 随机生成
	private static final String PREFIX = "--";
	private static final String LINE_END = "\r\n";
	private static final String CONTENT_TYPE = "multipart/form-data"; // 内容类型
	private UploadExUtil() {
	 ...
	 * @return
	 */
	public static UploadExUtil getInstance() {
		if (null == uploadUtil) {
			uploadUtil = new UploadExUtil();
		}
		return uploadUtil;
	}
	 ...
	 *            请求的URL
	 */
	public void uploadFile(String filePath, final String fileKey,String RequestURL, Map<String, String> param) {
		if (filePath == null) {
